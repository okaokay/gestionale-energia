...
router.put('/:tipo/:id/stato', async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        // Automazione pagamento commissione disabilitata qui: gestione centralizzata sulla rotta contratti quando il contratto diventa "Attivo"
        console.log('⏭️ Pagamento commissione non gestito in /clienti/:tipo/:id/stato');
